...
function verificarChute() {
    ...
    if (chute == numeroSecreto) {
        ...
        exibirTextoNaTela('p', chute > numeroSecreto ? 'O número secreto é menor escolha, um numero entre 1 e 10' : 'O número secreto é maior, escolha um numero entre 1 e 10');
        tentativas++;
        limparCampo();
    }
